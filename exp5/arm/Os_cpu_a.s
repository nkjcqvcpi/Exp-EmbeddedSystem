...
;**------------------------------------------------------------------------------------------------------
;** Modified by:        陈明计
;** Modified date:      2003-06-11
;** Version:            v1.1
;** Descriptions:       配合Vectors.s更正IRQ嵌套的BUG而作相应的修改
;**
;**------------------------------------------------------------------------------------------------------
;** Modified by:        陈明计
;** Modified date:      2003-06-13
;** Version:            v1.2
;** Descriptions:       按照μCOS-II V2.52的要求修改(以前是基于μCOS-II V2.0)
;**
;**------------------------------------------------------------------------------------------------------
;** Modified by:        陈明计
;** Modified date:      2003-06-13
;** Version:            v1.3
;** Descriptions:       不完全按照μCOS-II V2.52的要求以提高效率  
;**
;**------------------------------------------------------------------------------------------------------
;** Modified by:        甘达
